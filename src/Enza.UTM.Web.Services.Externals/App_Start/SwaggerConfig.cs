...
using Enza.UTM.Web.Services.Externals;
...
namespace Enza.UTM.Web.Services.Externals
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Enza.UTM.Web.Services.Externals");
        ...
        private static string ResolveBasePath(HttpRequestMessage message)
        {
            ...
            var schemeAndHost = string.Concat("https://", message.RequestUri.Authority);
