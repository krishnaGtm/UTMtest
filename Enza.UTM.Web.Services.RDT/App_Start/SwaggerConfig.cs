...
using Enza.UTM.Web.Services.RDT;
...
namespace Enza.UTM.Web.Services.RDT
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Enza.UTM.Web.Services.RDT");
        ...
        private static string ResolveBasePath(HttpRequestMessage message)
        {
            ...
            //var schemeAndHost = string.Concat(message.RequestUri.Scheme, "://", message.RequestUri.Authority);
            //return new Uri(new Uri(schemeAndHost, UriKind.Absolute), virtualPathRoot).AbsoluteUri;
            return ConfigurationManager.AppSettings["BaseRDTServiceUrl"];
        }
    }
}
