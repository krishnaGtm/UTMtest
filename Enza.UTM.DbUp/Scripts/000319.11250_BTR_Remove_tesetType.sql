...
DELETE FROM TestTypeDetermination WHERE TestTypeID = 8
GO

DELETE FROM TestType WHERE TestTypeID = 8
GO

ALTER TABLE Test
ADD ExcludeControlPosition BIT


DROP PROCEDURE IF EXISTS PR_GetTestsLookup
GO
-- =============================================  
-- Author:  Binod Gurung  
...
BEGIN  
    ...
    SELECT   
	 ...
	 T.Isolated,  
	 ST1.SlotID,  
	 WellsPerPlate = CASE WHEN ISNULL(T.ExcludeControlPosition,0) = 0 THEN  @TotalWells - ISNULL(T3.Blocked,0) ELSE @TotalWells END,  
...
DROP PROCEDURE IF EXISTS PR_GetWellPositionsLookup
GO
-- =============================================
-- Author:		Binod Gurung
