DROP INDEX IF EXISTS [IX_DeterminationName] ON [Determination]
GO

DROP INDEX IF EXISTS [IX_CropCode] ON [Determination]
GO

DROP INDEX IF EXISTS [IX_DetName_CropCode] ON [Determination]
GO


CREATE NONCLUSTERED INDEX [IX_DeterminationName] ON [Determination]
(
	DeterminationName 
)
GO

CREATE NONCLUSTERED INDEX [IX_CropCode] ON [Determination]
(
	CropCode 
)
GO

CREATE NONCLUSTERED INDEX [IX_DetName_CropCode] ON [Determination]
(
	DeterminationName, 
	CropCode 
)
...
AS BEGIN
	...
	BEGIN TRY
		...
		DECLARE @TVPDeterminations TVP_Determinations;
		...
		BEGIN
			...
			EXEC PR_SaveTestMaterialDetermination @testTypeID,@TestID,NULL,NULL,@TVPTMD,@TVPDeterminations
