DROP TABLE IF EXISTS [dbo].[RDTTraitDetResult]
GO


CREATE TABLE [dbo].[RDTTraitDetResult](
	[RDTTraitDetResultID] [int] IDENTITY(1,1) NOT NULL,
	[RelationID] [int] NOT NULL,
	[DetResult] [nvarchar](100) NULL,
	[TraitResult] [nvarchar](100) NULL,
	[MaterialStatus] [nvarchar](100) NULL,
	[MinPercent] [decimal](18, 3) NULL,
	[MaxPercent] [decimal](18, 3) NULL,
	[MappingCol] [nvarchar](100) NULL,
PRIMARY KEY CLUSTERED 
(
	[RDTTraitDetResultID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO


CREATE INDEX idx_RelationID_MaterialStatus
ON RDTTraitDetResult (RelationID , MaterialStatus )

GO

CREATE INDEX idx_RelationID_MappingCol
ON RDTTraitDetResult (RelationID , MappingCol )
...
VALUES (41, 'SiteLocation', 100, 'Active', 'Active'), (42, 'SiteLocation', 200, 'InActive', 'InActive')
	...
	BEGIN TRY
		...
		BEGIN
			...
			INSERT INTO [Test]([TestTypeID],[FileID],[RequestingSystem],[RequestingUser],[TestName],[CreationDate],[StatusCode],[PlannedDate], [MaterialStateID],
				[MaterialTypeID], [ContainerTypeID],[Isolated],[BreedingStationCode],[ExpectedDate],[SyncCode],[Cumulate], [ImportLevel], CountryCode, ExcludeControlPosition, SiteID)
			VALUES(@TestTypeID, @FileID, @Source, @UserID,@TestName , GETUTCDATE(), 100,@PlannedDate,@MaterialStateID, @MaterialTypeID, @ContainerTypeID, 
				@Isolated,@BreedingStationCode, @ExpectedDate,@SyncCode, @Cumulate, @ImportLevel, @CountryCode, @ExcludeControlPosition, @SiteID);
